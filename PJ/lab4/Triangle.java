...
public class Triangle implements Comparable<Triangle> {
	...
	public Triangle(Triangle triangle) {
		...
		this.setFigureColor(triangle.getFigureColor());
	}
	...
	private void setDefaultColor() {
		this.setFigureColor(new Color(85, 139, 47, 120));
	}
 ...
 */
	...
	public void drawFigure(Graphics g, int biasX, int biasY) {
		int scale = 10;
	...
	public void drawFigureWithoutFill(Graphics g, int biasX, int biasY) {
		int scale = 10;
		int[] xPoints = {(int) (A.getX()+ biasX)*scale , (int) (B.getX()+ biasX)*scale, (int) (C.getX()+ biasX)*scale};
		int[] yPoints = {(int) (A.getY()+ biasY)*scale  , (int) (B.getY()+ biasY)*scale , (int) (C.getY()+ biasY)*scale };
		int nPoints = xPoints.length;
	...
	public void drawFigure(Graphics g, int biasX, int biasY, int scale) {
		int[] xPoints = {(int) (A.getX()+ biasX)*scale , (int) (B.getX()+ biasX)*scale, (int) (C.getX()+ biasX)*scale};
		int[] yPoints = {(int) (A.getY()+ biasY)*scale  , (int) (B.getY()+ biasY)*scale , (int) (C.getY()+ biasY)*scale };
		int nPoints = xPoints.length;
		g.setColor(getFigureColor());
	...
	public void drawFigureWithoutFill(Graphics g, int biasX, int biasY, int scale) {
		int[] xPoints = {(int) (A.getX()+ biasX)*scale , (int) (B.getX()+ biasX)*scale, (int) (C.getX()+ biasX)*scale};
		int[] yPoints = {(int) (A.getY()+ biasY)*scale  , (int) (B.getY()+ biasY)*scale , (int) (C.getY()+ biasY)*scale };
		int nPoints = xPoints.length;
		g.setColor(getFigureColor());
